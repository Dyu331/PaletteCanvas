...
struct Help4View_Previews: PreviewProvider {
    static var previews: some View {
        Help4View(backToLevel: .constant(false),user1: .constant(Color(red: 0.5, green: 0.5, blue: 0.5)),user2: .constant(Color(red: 0.5, green: 0.5, blue: 0.5)),user3: .constant(Color(red: 0.5, green: 0.5, blue: 0.5)),user4: .constant(Color(red: 0.5, green: 0.5, blue: 0.5)))
    }
}
